...
All the code for the site is available in [this GitHub repository](https://github.com/ori-livson/blog), but hopefully many of these techniques will be useful to anyone who wants to make static websites on the cheap, whether you want to use a functional programming style or not.